  ...
  return (
    <section className="min-h-screen flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-dark via-dark-gray to-dark">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-primary/20 via-transparent to-transparent animate-pulse"></div>
      </div>
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          ...
          <div className="flex-1 text-center lg:text-left">
            <div className="space-y-6">
              ...
              {/* Contact Info */}
              <div className="flex flex-wrap gap-4 justify-center lg:justify-start text-sm lg:text-base">
                <a
                  href={`mailto:${data.email}`}
                  className="glass-effect px-4 py-2 rounded-lg hover:bg-white/10 transition-all flex items-center gap-2"
                >
              ...
              <div className="flex gap-4 justify-center lg:justify-start">
                <a
                  ...
                  className="glass-effect p-3 rounded-lg hover:bg-primary/20 hover:scale-110 transition-all"
                  aria-label="LinkedIn"
                >
